...
- **On the Perception Bottleneck of VLMs for Chart Understanding**
  Junteng Liu, Weihao Zeng, Xiwen Zhang, Yijun Wang, Zifei Shan, Junxian He. *Arxiv*, 2025. (First author) Code: [Vision4Chart](https://github.com/Vicent0205/Vision4Chart)

- **On the Universal Truthfulness Hyperplane Inside LLMs**
  Junteng Liu, Shiqi Chen, Yu Cheng, Junxian He. *EMNLP 2024*. (First author) Code: [Universal_Truthfulness_Hyperplane](https://github.com/Vicent0205/Universal_Truthfulness_Hyperplane)
